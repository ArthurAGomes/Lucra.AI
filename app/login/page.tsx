...
import { Eye, EyeOff, Loader2, Sparkles, Shield, Zap } from 'lucide-react';
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/70">IA avançada para suas decisões financeiras</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/70">Seus dados protegidos com criptografia</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/70">Interface rápida e responsiva</p>
                </div>
              </div>
            </div>
          </div>
